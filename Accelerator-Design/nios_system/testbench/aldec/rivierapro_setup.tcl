...
alias com {
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/nios_system_new_sdram_controller_0_test_component.v"                                                 -work new_sdram_controller_0                                                
  ...
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/nios_system_tb/simulation/submodules/altera_sdram_partner_module.v"                                                                       -work new_sdram_controller_0_my_partner                                     
